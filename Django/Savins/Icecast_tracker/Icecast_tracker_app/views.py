...
def channel_list(request):
	...
	return render(request, 'icecast_tracker_app/channel_list.html', {'channels':channels})
...
def play_channel(request):
	...
	if finalAddress == "":
		return render(request, 'icecast_tracker_app/error_channel.html')
	else:
		url = "http://"+finalAddress + ":" + str(finalPort) +"/"+finalPath
		#return render(request, 'icecast_tracker_app/play_channel.html', {'url':url})
